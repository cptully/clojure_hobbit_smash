...
(comment
  (defn symmetrize-body-parts
    "Expects a seq of maps that have a :name :size"
    [asym-body-parts]
...
;(def body-parts (better-symmetrize-body-parts asym-hobbit-body-parts))
